...
const WhyUsSection = () => {
  return (
    ...
    {/* Floating card - Detached to layer above sections */}
      <div className="relative z-20 pointer-events-none mt-12 sm:mt-0">
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16">
            <div className="relative order-2 lg:order-1">
              <div className="absolute -top-8 sm:-top-16 md:-top-20 right-3 sm:right-4 md:right-8 p-4 sm:p-5 rounded-xl bg-primary border-2 border-primary shadow-2xl transform -rotate-3 pointer-events-auto">
