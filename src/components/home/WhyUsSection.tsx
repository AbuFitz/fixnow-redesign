...
const WhyUsSection = () => {
  return (
    <section className="py-16 sm:py-20 md:py-24 lg:py-28 bg-gradient-to-br from-background via-surface/50 to-card relative overflow-hidden">
      {/* Accent glow */}
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 relative z-10 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-center min-h-[600px] lg:min-h-[700px]">
          ...
          <div className="relative order-2 lg:order-1 max-w-md mx-auto w-full">
            ...
            {/* Floating card */}
            <div className="absolute -bottom-8 sm:-bottom-10 left-1/2 -translate-x-1/2 w-[90%] max-w-xs p-4 sm:p-5 rounded-xl bg-primary border-2 border-primary shadow-2xl">
