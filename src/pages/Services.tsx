      ...
      <section className="py-8 md:py-10 border-b border-border/50">
        <div className="container mx-auto px-6 md:px-12">
          <div className="max-w-4xl">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-card border border-border/50 mb-3">
              <Wrench className="w-3.5 h-3.5 text-primary" />
              <span className="text-xs font-medium text-muted-foreground uppercase tracking-wider">Mobile Services</span>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 max-w-6xl mx-auto">
            ...
            <div className="group bg-gradient-to-br from-card via-card to-card/80 rounded-3xl overflow-hidden border-2 border-primary/40 hover:border-primary transition-all duration-500 hover:shadow-2xl hover:shadow-primary/20">
              <div className="relative h-48 md:h-64 overflow-hidden">
                ...
                <div className="absolute top-4 left-4 bg-gradient-to-r from-primary to-primary/90 text-primary-foreground px-3 md:px-4 py-1.5 md:py-2 rounded-full font-bold text-xs md:text-sm uppercase tracking-wider shadow-lg backdrop-blur-sm flex items-center gap-1.5">
            ...
            <div className="group bg-gradient-to-br from-card via-card to-card/80 rounded-3xl overflow-hidden border border-border hover:border-primary/40 transition-all duration-500 hover:shadow-2xl">
              <div className="relative h-48 md:h-64 overflow-hidden">
                <img 
                  ...
                  alt="Interim Service"
                  loading="lazy"
                  className="w-full h-full object-cover object-[center_25%] group-hover:scale-105 transition-transform duration-500 brightness-75 contrast-110"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-card via-card/50 to-transparent" />
                <div className="absolute top-4 right-4 bg-primary text-primary-foreground px-3 md:px-4 py-1.5 md:py-2 rounded-full font-bold text-base md:text-lg">
                  From £110
