        ...
        <div className="container mx-auto px-4 md:px-6 max-w-2xl">
          ...
          <div className="text-center mb-8 md:mb-10">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 border border-primary/20 mb-4">
              ...
              <span className="text-xs font-medium text-primary uppercase tracking-wider">Interim Service</span>
            </div>
            <h1 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-3">
              Book Your <span className="text-primary">Interim Service</span>
            </h1>
            <p className="text-sm md:text-base text-muted-foreground">
              From £110 • Takes approximately 1 hour
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8">
            ...
            <div className="space-y-3 md:space-y-4">
              <Button type="submit" className="w-full rounded-full h-11 md:h-12 font-semibold text-sm md:text-base">
                Request Interim Service Booking
                <ArrowRight className="w-4 h-4 ml-2" />
              </Button>
