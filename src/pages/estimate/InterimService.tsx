    ...
    try {
      ...
      if (result.success) {
        ...
        toast.success("Booking Received!", {
          description: "We'll confirm your interim service appointment shortly.",
          duration: 5000,
        });
            ...
            <div className="py-12 md:py-16 flex items-center justify-center min-h-[60vh]">
              <div className="bg-card rounded-2xl p-8 md:p-12 border border-border shadow-lg text-center max-w-2xl w-full">
                ...
                <p className="text-base md:text-lg text-muted-foreground mb-8">
                  We've received your interim service booking and will confirm your appointment within 1 business day.
                </p>
                  ...
                  <div className="space-y-4">
                    <div className="w-full">
                      ...
                      <Input 
                        ...
                        onChange={handleInputChange}
                        className="h-11 text-base w-full max-w-full"
                        style={{ fontSize: '16px' }}
                      />
                    </div>
